...
export class IWannaGame {
  ...
  private drawButton(c:CanvasRenderingContext2D,b:ButtonRun):void{
    ...
    if(b.target!=='boss'&&!b.pressed){const pulse=.5+.5*Math.sin(this.time*4+b.x*.01);c.globalAlpha=.28+pulse*.16;c.fillStyle=art.secondary;this.roundRect(c,b.x-9,b.y+b.h+5,b.w+18,5,2);c.fill();c.globalAlpha=1;}
    if(b.target==='boss'){
