...
- `v3/remix.ts`：早期宽关卡扩展。
- `v6/campaign.ts`：24 套四段房间、动作锁、合同、攻击主题和序章/Boss 升级。
- `v14/progression.ts`：每章六级压力表、阶段名称与检查点轮廓映射。
...
| `v7/hardcore-mechanics.ts` | 追逐速度、瞄准、预判与明确合同 |
