...
![Version](https://img.shields.io/badge/version-12.3.0-d5a546)
![TypeScript](https://img.shields.io/badge/TypeScript-strict-3178c6)
![Tests](https://img.shields.io/badge/tests-86%20passed-3f8378)
...
7. [测试、调试与性能](docs/07-测试调试与性能.md)：86 项测试、Debug API、性能预算和回归流程。
...
v12.3 是可完整游玩、可离线运行、可公开分享的版本。未来方向记录在 GDD 的“开放问题与后续范围”中；未写入当前范围的多人、服务器排行榜、云存档和商业付费系统不属于当前实现。
