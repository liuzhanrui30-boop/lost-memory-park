...
![Version](https://img.shields.io/badge/version-12.6.0-d5a546)
![TypeScript](https://img.shields.io/badge/TypeScript-strict-3178c6)
![Tests](https://img.shields.io/badge/tests-98%20passed-3f8378)
...
v12.6 延续按设备使用两档明确的内部画布，不让浏览器盲目按 Retina 倍率无限增加填充量：
...
- v12.6 最终高压房间自动化实测平均帧间隔 16.666ms、约 60.0 FPS，P99 为 17.5ms。该数字来自本机自动化浏览器，真实表现仍取决于设备。
...
7. [测试、调试与性能](docs/07-测试调试与性能.md)：98 项测试、Debug API、双端性能预算和回归流程。
...
v12.6 是可在电脑与手机横屏完整游玩、可离线运行、可公开分享的版本。它移除了缺少回报闭环的连拍与热度系统，把 24 个普通房间重排为每章六级递进，并把每关的四段目标、房间序号和四类检查点直接显示给玩家。未来方向记录在 GDD 的“开放问题与后续范围”中；未写入当前范围的多人、服务器排行榜、云存档和商业付费系统不属于当前实现。
